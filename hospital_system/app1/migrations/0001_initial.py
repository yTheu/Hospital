# Generated by Django 5.1.3 on 2024-12-11 15:15
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('genero', models.CharField(blank=True, choices=[('F', 'Feminino'), ('M', 'Masculino'), ('O', 'Outro')], max_length=1, null=True)),
                ('salario', models.DecimalField(blank=True, decimal_places=2, max_digits=10, null=True)),
                ('turno', models.CharField(blank=True, choices=[('M', 'Manhã'), ('T', 'Tarde'), ('N', 'Noite'), ('F', 'Flexível')], max_length=1, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Médico',
            fields=[
                ...
                ('nome', models.CharField(max_length=100)),
                ('cpf', models.CharField(max_length=11)),
                ('especializacao', models.CharField(choices=[('CLINICA_GERAL', 'Clínica Geral'), ('PEDIATRIA', 'Pediatria'), ('GINECOLOGIA', 'Ginecologia'), ('CARDIOLOGIA', 'Cardiologia'), ('ORTOPEDIA', 'Ortopedia')], max_length=50)),
                ('disponibilidade', models.BooleanField(default=True)),
                ('contratada', models.BooleanField(default=True)),
                ('data_nascimento', models.DateField()),
                ('endereco', models.CharField(max_length=250)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo', models.CharField(choices=[('A', 'Analgésico'), ('B', 'Antibiótico'), ('C', 'Corticóide'), ('D', 'Descongestionante')], max_length=1)),
